...
function sendApprovalEmail(post) {
    ...
    sendSmtpEmail.htmlContent = `A new post "${post.name}" has been added and needs your approval.   <p>Click <a href="http://localhost:3333/">here</a> to go to your application.</p>`;
